...
//    DSpace dspace = new DSpace();
    ...
    private void addAll(Collection col) throws SQLException, ContextServiceException {
        Iterator<Item> items = itemService.findAllByCollection(contextService.getContext(), col);
        while (items.hasNext()) {
            itemsToUpdate.add(items.next());
        }
    }
    ...
    public void end(Context ctx) throws Exception {
        ...
        try {
            if (itemsToUpdate != null) {
                ...
                anonymousContext = contextService.getContext();
