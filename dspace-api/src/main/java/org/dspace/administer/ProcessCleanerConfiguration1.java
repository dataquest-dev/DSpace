...
/**
 * The {@link ScriptConfiguration} for the {@link ProcessCleaner1} script.
 */
public class ProcessCleanerConfiguration1<T extends ProcessCleaner1> extends ScriptConfiguration<T> {
