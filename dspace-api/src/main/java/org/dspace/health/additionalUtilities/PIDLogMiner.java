...
public class PIDLogMiner {
    ...
    private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(PIDLogMiner.class);
    ...
    {
        return configurationService.getProperty("log.dir");
    }
