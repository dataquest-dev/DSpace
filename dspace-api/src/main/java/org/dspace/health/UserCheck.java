    ...
    public String run(ReportInfo ri) {
        ...
        try {
            ...
            for (EPerson e : epersons) {
                ...
                // Counted from the self-registration flag, not from netid: the netid test was a
                // copy-paste of the line above it and made this number a duplicate of "Have netid".
