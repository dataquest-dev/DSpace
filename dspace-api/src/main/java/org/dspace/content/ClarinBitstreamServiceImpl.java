...
public class ClarinBitstreamServiceImpl implements ClarinBitstreamService {
    ...
    public boolean validation(Context context, Bitstream bitstream)
        ...
        Map<String, Object> receivedMetadata =
                new HashMap<>(bitstreamStorageService.computeChecksum(context, bitstream));
        File file = bitstreamStorageService.retrieveFile(context, bitstream);
        if (Objects.nonNull(file)) {
            receivedMetadata.put("size_bytes", file.length());
        }
