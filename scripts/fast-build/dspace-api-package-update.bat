...
xcopy /e /h /i /q /y %dspace_source%\dspace-api\target\dspace-api-7.6.5.jar %tomcat%\webapps\server\WEB-INF\lib\
xcopy /e /h /i /q /y %dspace_source%\dspace-api\target\dspace-api-7.6.5.jar %dspace_application%\lib\
