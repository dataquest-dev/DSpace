...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        <oai_dc:dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/"
            ...
            <!--
                                   <xsl:for-each select="doc:header/doc:setSpec">
                                           <dc:test><xsl:value-of select="." /></dc:test>
                                   </xsl:for-each>
            <xsl:choose>
                   <xsl:when test="doc:header/doc:setSpec = 'col_10563_26293'"><dc:type>katalog vystavy</dc:type></xsl:when>
                   <xsl:when test="doc:header/doc:setSpec = 'col_10563_26294'"><dc:type>konferencni sbornik</dc:type></xsl:when>
                   <xsl:when test="doc:header/doc:setSpec = 'col_10563_26292'"><dc:type>vyrocni zprava</dc:type></xsl:when>
                   <xsl:when test="doc:header/doc:setSpec = 'col_10563_26291'"><dc:type>metodika</dc:type></xsl:when>
                   <xsl:otherwise>
