...
public class BrowsesResourceControllerIT extends AbstractControllerIntegrationTest {
    ...
    public void testBrowseByEntriesStartsWith() throws Exception {
        ...
        getClient().perform(get("/api/discover/browses/author/entries?startsWith=T")
                   ...
                   .andExpect(jsonPath("$._embedded.entries",
                                       contains(BrowseEntryResourceMatcher.matchBrowseEntry("Turing, Alan Mathison".toLowerCase(), 1)
                                       )))
        ...
        getClient().perform(get("/api/discover/browses/subject/entries?startsWith=C"))
                   ...
                   .andExpect(jsonPath("$._embedded.entries",
                                       contains(BrowseEntryResourceMatcher.matchBrowseEntry("Computing".toLowerCase(), 3)
                                       )))
                   //Verify that the startsWith paramater is included in the links
    ...
    public void testBrowseByEntriesStartsWithAndDiacritics() throws Exception {
        ...
        getClient().perform(get("/api/discover/browses/author/entries?startsWith=A")
                   ...
                   .andExpect(jsonPath("$._embedded.entries",
                                       contains(BrowseEntryResourceMatcher.matchBrowseEntry("Alonso, Nombre".toLowerCase(), 1),
                                                BrowseEntryResourceMatcher.matchBrowseEntry("Álvarez, Nombre".toLowerCase(), 1),
                                                BrowseEntryResourceMatcher.matchBrowseEntry("Azuaga, Nombre".toLowerCase(), 1)
                                               )))
        ...
        getClient().perform(get("/api/discover/browses/author/entries?startsWith=Ó"))
                   ...
                   .andExpect(jsonPath("$._embedded.entries",
                                       contains(BrowseEntryResourceMatcher.matchBrowseEntry("Ögren, Name".toLowerCase(), 1),
                                                BrowseEntryResourceMatcher.matchBrowseEntry("Ortiz, Nombre".toLowerCase(), 1)
                                               )))
                   //Verify that the startsWith paramater is included in the links
        ...
        getClient().perform(get("/api/discover/browses/subject/entries?startsWith=Tele"))
                   ...
                   .andExpect(jsonPath("$._embedded.entries",
                                       contains(BrowseEntryResourceMatcher.matchBrowseEntry("Telecomunicaciones".toLowerCase(), 1),
                                                BrowseEntryResourceMatcher.matchBrowseEntry("Teléfono".toLowerCase(), 1),
                                                BrowseEntryResourceMatcher.matchBrowseEntry("Televisor".toLowerCase(), 1)
                                               )))
                   //Verify that the startsWith paramater is included in the links
