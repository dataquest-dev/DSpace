...
public class RequestItemRepositoryIT
    ...
    public void testDeleteBitstreamRemovesRequestItem() throws Exception {
        ...
        // Re-attach entities to the current Hibernate session: the REST POST above committed the
        // context (detaching item/bitstream). BitstreamServiceImpl.delete runs CLARIN
        // updateItemFilesMetadata, which mutates item metadata and requires an attached item.
