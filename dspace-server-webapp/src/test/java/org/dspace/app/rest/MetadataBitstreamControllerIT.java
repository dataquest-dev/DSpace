    ...
    public void downloadAllZipWithDoubleQuotesInItemName() throws Exception {
        ...
        getClient(token).perform(get(METADATABITSTREAM_ENDPOINT + "/" + itemWithQuotes.getID() +
                ...
                .andExpect(header().string("Content-Disposition",
                        "attachment; filename=\"Supported data for manuscript \\\"Thermally-induced evolution\\\".zip\";"
                        + " filename*=UTF-8''Supported%20data%20for%20manuscript%20%22Thermally-induced"
                        + "%20evolution%22.zip"));
    }
