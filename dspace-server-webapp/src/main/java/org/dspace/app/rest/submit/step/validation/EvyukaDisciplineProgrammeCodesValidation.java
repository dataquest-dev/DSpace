...
public class EvyukaDisciplineProgrammeCodesValidation extends AbstractValidation {
    ...
    private static final String ERROR_VALIDATION_EVYUKA_DISCIPLINE_REQUIRED = "error.validation.evyuka.discipline.required";
    private static final String ERROR_VALIDATION_EVYUKA_PROGRAMME_REQUIRED = "error.validation.evyuka.programme.required";
    
    // Error message when no discipline/programme codes are provided at all
    private static final String ERROR_VALIDATION_EVYUKA_DISCIPLINE_PROGRAMME_CODES_REQUIRED = "error.validation.evyuka.discipline.programme.codes.required";
