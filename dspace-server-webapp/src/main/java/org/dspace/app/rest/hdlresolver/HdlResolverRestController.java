...
public class HdlResolverRestController {
     ...
     * Example:
     *      <ul>
     *          <li>Request: GET - http://{dspace.server.url}/hdlresolver/handleIdExample/1</li>
     ...
     * Example:
     *      <ul>
     *          <li>Request: GET - http://{dspace.server.url}/listprefixes</li>
     ...
     * Example:
     *      <ul>
     *          <li>Request: GET - http://{dspace.server.url}/listhandles/prefix</li>
