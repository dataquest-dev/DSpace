...
public class EvyukaCodesValidation extends AbstractValidation {
    ...
    private static final String ERROR_VALIDATION_EVYUKA_CODES_ALL_REQUIRED =
            "error.validation.evyuka.codes.all.required";
    private static final String ERROR_VALIDATION_EVYUKA_CODES_SUBJECT_ONLY_REQUIRED =
            "error.validation.evyuka.codes.subject.only.required";
    private static final String ERROR_VALIDATION_EVYUKA_CODES_DISCIPLINE_ONLY_REQUIRED =
    ...
    public List<ErrorRest> validate(SubmissionService submissionService, InProgressSubmission obj,
        ...
        if (!isValidationPassed(formType, hasAnySubjectValues, hasAnyDisciplineValues,
                hasAllSubjectValues, hasAllDisciplineValues)) {
    ...
    private void addAdditionalL2Errors(List<ErrorRest> errors, SubmissionStepConfig config, FormType formType,
        ...
        switch (formType) {
            ...
            case DISCIPLINE_ONLY:
                ...
                break;
            default:
                // No additional validation for unknown form types
                break;
        }
