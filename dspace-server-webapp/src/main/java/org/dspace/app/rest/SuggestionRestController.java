...
//import org.dspace.app.rest.model.MetadataValueRestWithField;
...
//
//@RestController
//@RequestMapping("/api/" + MetadataValueRestWithField.CATEGORY + SuggestionRestController.CATEGORY)
...
//    public Page<MetadataValueRestWithField> getSuggestions(HttpServletRequest request,
...
//        }
//
//        Page<MetadataValueRestWithField> resp = converter.toRestPage(matchingMetadataValues, pageable, utils.obtainProjection());
//        return resp;
//    }
//
...
//                .register(this,
//                        Arrays.asList(
//                                new Link(new UriTemplate("/api/" + MetadataValueRestWithField.CATEGORY + CATEGORY),
//                                        CATEGORY)));
//    }
//}